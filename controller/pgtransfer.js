...
const PgTransfer = models.PgTransfer;
var moment = require("moment");

const create = async (req, res) => {
  try {
    const data = req.body;
    await PgTransfer.create(data)
      .then((data) => {
        res.json({
          status: 200,
          message: "SUCCESS",
...
const viewByid = async (req, res) => {
  try {
    ...
    await PgTransfer.findAll({ where: { id: data } })
      .then((data) => {
        res.send(data);
      })
      .catch((err) => {
...
const destroy = async (req, res) => {
  try {
    const data = req.body.id;
    await PgTransfer.destroy({ where: { id: data } })
      .then(() => {
